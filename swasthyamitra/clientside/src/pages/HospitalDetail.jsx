        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-slate-800 mt-1">{hospital.phone || "Not available"}</p>
            </div>

            <div>
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Email</p>
              <p className="text-slate-800 mt-1">{hospital.email || "Not available"}</p>
            </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-16 h-16 rounded-full overflow-hidden shrink-0 bg-slate-100">
                      <img src={getDoctorImage(doctor.image)} alt={doctor.name} className="w-full h-full object-cover" />
                    </div>
                    <div className="min-w-0 flex-1">
